...
import com.application.firebase.databinding.ActivityAnimalAddBinding
...
//            Store in ModelClass
    ...
    private fun uploadimage() {
        ...
        val storageReference = FirebaseStorage.getInstance()
            .getReference(System.currentTimeMillis().toString() + "images/$filename")
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 101) {
            ...
            var path =
                MediaStore.Images.Media.insertImage(this.contentResolver, bitmap, "val", null)
