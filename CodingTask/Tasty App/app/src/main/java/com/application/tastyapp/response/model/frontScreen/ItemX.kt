...
data class ItemX(
    ...
    val renditions: List<RenditionXXX>,
    ...
    @SerializedName("show")
    val show: ShowXXXXXXX,
    @SerializedName("show_id")
    val showId: Int,
    @SerializedName("slug")
    val slug: String,
    @SerializedName("tags")
    val tags: List<TagXXX>,
